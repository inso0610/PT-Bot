module.exports = (message) => {
    ...
    if (content.toUpperCase().includes('[PING]') && ((message.member.roles.cache.has('1111370796439453777') || message.member.roles.cache.has('1140260309915938866') || message.member.roles.cache.has('1142479698635526304')))) {
