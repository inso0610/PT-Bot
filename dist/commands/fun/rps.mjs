...
var require_rps = __commonJS({
  "src/commands/fun/rps.js"(exports, module) {
    init_esm_shims();
    var { SlashCommandBuilder, EmbedBuilder } = __require("discord.js");
    module.exports = {
      data: new SlashCommandBuilder().setName("rps").setDescription("Play rock paper scissors against the bot").addStringOption((option) => option.setName("selection").setDescription("Do you want to play rock, paper or scissors?").setRequired(true).addChoices(
      ...
      run: ({ interaction, client, handler }) => {
        ...
        try {
          if (selection === "Rock" && botSelection === 1) {
            gameEmbed = new EmbedBuilder().setTitle(`Rock Paper Scissors: ${interaction.user.tag} vs PT Assistance`).setDescription(`Your selection: ${selection}
