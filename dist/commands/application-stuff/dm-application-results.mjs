...
var require_dm_application_results = __commonJS({
  "src/commands/application-stuff/dm-application-results.js"(exports, module) {
    ...
    module.exports = {
      data: new SlashCommandBuilder().setName("dm-results").setDescription("Sends a DM with Signaller Manager application results."),
      run: async ({ interaction, client, handler }) => {
        let feedbackEmbed = new EmbedBuilder().setTitle("Application Feedback").setDescription(`# Signaller Manager application results:

            \u2705 \u{1F44F} | Congratulations you passed the Signaller Manager application!
        ...
        if (interaction.user.id === "764095520440188978") {
          feedbackEmbed = new EmbedBuilder().setTitle("Application Feedback").setDescription(`# Signaller Manager application results:
